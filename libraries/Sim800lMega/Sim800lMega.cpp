 ...
 *  Designed to work with the GSM Sim800lMega,maybe work with SIM900L
 *  
...
/// will use Mega 3 UARTS  Serial, Serial 2 and Serial 3

void Sim800lMega::begin(){
	Serial3.begin(9600);
  #if (LED) 
...
//PRIVATE METHODS
//
String Sim800lMega::_readSerial(){
  _timeout=0;
...
void Sim800lMega::setPhoneFunctionality(){
  /*AT+CFUN=<fun>[,<rst>] 
  Parameters
...
void Sim800lMega::signalQuality(){
/*Response
...
void Sim800lMega::activateBearerProfile(){
...
void Sim800lMega::deactivateBearerProfile(){
...
void  Sim800lMega::callNumber(char* number){
  Serial3.print (F("ATD"));
...
uint8_t Sim800lMega::getCallStatus(){
/*
  values of return:
...
bool Sim800lMega::sendSms(char* number,char* text){
...
String Sim800lMega::getNumberSms(uint8_t index){
...
String Sim800lMega::readSms(uint8_t index){
...
void Sim800lMega::RTCtime(int *day,int *month, int *year,int *hour,int *minute, int *second){
...
bool Sim800lMega::updateRtc(int utc){
